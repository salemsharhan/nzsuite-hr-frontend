...
export const Sidebar = ({ collapsed, setCollapsed, mobileOpen, setMobileOpen }: any) => {
  ...
  const menuItems = [
    ...
    { icon: ClipboardCheck, label: t('layout.hrApprovals', { defaultValue: 'Approvals' }), href: '/approvals', roles: ['super_admin', 'admin'] },
    ...
    { icon: FileText, label: t('layout.hiringChecklist'), href: '/hiring-checklist', roles: ['super_admin', 'admin', 'employee'] },
